...
<body>
    ...
    <div class="admin-page-wrapper">
        ...
        <div class="admin-content">
            ...
            <div class="content">
                <h2 class="page-title">Управление темами</h2>
                    ...
                    <tbody>
                        <?php foreach ($topics as $key => $topic) : ?>
                            <tr>
                                ...
                                <td><a href="edit.php?id=<?php echo $topic['id']; ?>" class="edit">Редактировать</a></td>
                                <td><a href="index.php?del_id=<?php echo $topic['id']; ?>" class="delete">Удалить</a></td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
